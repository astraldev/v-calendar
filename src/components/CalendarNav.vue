  ...
  <div class="c-nav">
    ...
    <div v-if="mode_ === 'month'">
      ...
      <div class="c-header" :style="headerStyle">
        ...
        <!--Mode switch button-->
        <span class="c-title" :style="headerTitleStyle" @click="selectMode('year')">
          {{ yearIndex }}
        </span>
        <!--Next year button-->
        <div class="c-arrow-layout">
    ...
    <div v-if="mode_ === 'year'">
      <div class="c-header" :style="headerStyle">
        ...
        <!--Mode switch button-->
        <span class="c-title" :style="headerTitleStyle" @click="selectMode('month')">
          {{ firstYear }} - {{ lastYear }}
        </span>
  ...
  computed: {
    ...
    firstYear() {
      return getFirstArrayItem(
        this.yearItems.map((i) => i.year),
        0
      );
    },
    lastYear() {
      return getLastArrayItem(
        this.yearItems.map((i) => i.year),
        0
      );
    },
